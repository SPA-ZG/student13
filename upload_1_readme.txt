...
Napomene:
    - Aplikacija je deployana na Render.com, ali početno učitavanje može potrajati nekoliko minuta jer Render.com ugasi aplikaciju ako se ne koristi neko vrijeme.
    - Kod pokretanja lokalno s 'npm run serve' aplikacija je dostupna na http://localhost:3000 te koristi lokalni backend
